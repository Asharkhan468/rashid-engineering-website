        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
          ...
          <div className="bg-white p-6 sm:p-10 rounded-3xl shadow-xl border border-gray-200">
            <form className="space-y-4 sm:space-y-6">
              ...
              <button className="w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white py-3 sm:py-4 rounded-xl font-semibold shadow-lg hover:shadow-2xl transition duration-300">
                Send Message
              </button>
            </form>
          </div>
